const Footer = () => {
    return (
            <div id="footer">
        <div className="footer-block bg-white pt-60">
              ...
              <div className="col-xl-3 col-md-6">
                <div className="footer-company-infor d-flex flex-column gap-20">
                  <a className="logo" href="index.html">
                    ...
                    >
                      <g clipPath="url(#clip0_7015_1136)">
                        <path
                          fillRule="evenodd"
                          clipRule="evenodd"
                  ...
                  <div className="caption1">
                    Welcome to Bytewave! We provide diverse IT solutions with a team
                    of experts. From IT management to cloud solutions, we have you
                    covered.{" "}
                  </div>
                  <div className="caption1">
                ...
                <div className="footer-navigate">
                  <div className="footer-nav-item">
                    ...
                    <ul className="list-nav mt-12">
                      <li className="mt-8">
                        <a
                          className="caption1 text-line hover-underline"
                          href="about-us.html"
                        >
                          About us
                        </a>
          ...
          <div className="border-line mt-60" />
          <div className="bg-white">
            <div className="container bg-white">
              <div className="footer-bottom flex-between pt-8 pb-8">
                <div className="left-block flex-item-center">
                  <div className="copy-right text-on-surface-variant1 caption1">
                    ©2023 ByteWave. All Rights Reserved.
                  </div>
                </div>
                <div className="nav-link flex-item-center gap-10">
                  <a
                    className="text-on-surface-variant1 caption1 hover-underline"
                    href="#!"
                  >
                    Terms Of Services
                  </a>
                  <span className="text-on-surface-variant1 caption1">|</span>
                  <a
                    className="text-on-surface-variant1 caption1 hover-underline"
                    href="#!"
                  >
